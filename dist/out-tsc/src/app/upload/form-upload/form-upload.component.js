...
var FormUploadComponent = /** @class */ (function () {
    ...
    FormUploadComponent.prototype.delete = function (id) {
        ...
        if (conf === true) {
            this.http.delete('http://localhost:8888/api/file/delete/' + id).subscribe(function (data) {
    ...
    FormUploadComponent = __decorate([
        ...
        __metadata("design:paramtypes", [UploadFileService, ActivatedRoute, HttpClient])
    ], FormUploadComponent);
